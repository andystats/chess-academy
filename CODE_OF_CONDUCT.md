...
This Code applies in all project spaces (issues, pull requests, discussions) and when
representing the project publicly.

Report unacceptable behavior by opening a confidential issue to the maintainers or contacting them
directly. Maintainers will review and respond, and may remove content, comments, or contributors
