...
// public-domain work at the chapter level, while this app keeps every summary, prompt, and lesson
// explanation newly written.
...
export const MY_SYSTEM_PARTS = [
  ...
  },
  {
    ...
    summary: 'The elements become a method: prophylaxis, restraint, overprotection, centre play, pawn-structure weaknesses, and manoeuvring.',
    chapters: [
      {
      ...
      },
      {
        id: 'maneuvering',
        number: 'VI',
        title: 'Manoeuvring Against Enemy Weaknesses',
        summary: 'The terrain, the pivot, combined play on both wings, latent weaknesses, and manoeuvring under central pressure.',
        status: 'planned',
      },
    ],
  },
  {
    ...
    summary: 'Annotated career games become case files, each revisiting the earlier principles on a living board.',
    chapters: [
      {
        id: 'case-files',
        number: 'XIII',
        title: 'Game Case Files',
        summary: 'Future studies will connect the chapter ideas to full-game decisions and turning points.',
        status: 'planned',
      },
    ],
  },
