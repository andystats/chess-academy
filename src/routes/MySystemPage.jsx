    ...
    <article className="grid gap-5 border-t border-gray-300 py-7 lg:grid-cols-[minmax(0,1fr)_14rem] lg:items-start">
      <div>
        <div className="flex flex-wrap items-baseline gap-x-3 gap-y-2">
          ...
          <span className="study-chip text-gray-600">
        ...
        {lesson ? (
          ...
          <p className="mt-5 inline-flex min-h-touch items-center gap-2 border border-gray-300 bg-white px-4 font-semibold text-gray-600">
      ...
      <section className="mx-auto grid max-w-6xl gap-8 px-4 py-10 lg:grid-cols-[17rem_minmax(0,1fr)]">
        <aside className="lg:sticky lg:top-24 lg:self-start">
          <div className="study-panel p-5">
            ...
            <nav className="mt-6 space-y-3 border-t border-gray-300 pt-5" aria-label="My System parts">
